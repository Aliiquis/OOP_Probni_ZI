...
public class Main {
    ...
    public static void main(String[] args) {
        List<BillionaireDatum> dataset = BillionaireLoader.load("src/main/resources/forbes_2022_top500.tsv");
        ...
        for (Map.Entry<Integer, Long> worthBucket : BillionaireStats.makeHistogram(dataset, 30000).entrySet()) {
